---
title: "Co-Development of Obesity Risk, Depressive Symptoms, and Relative Pubertal
  Development"
...
Summary: Based on the above model building steps of estimating models with unconstrained and constrained cross lagged paths and then performing likelihood ratio tests to rest if constraining results
in decrements in model fit, all cross lagged paths should be left unconstrained.
